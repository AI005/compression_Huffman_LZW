...
//{
//	string inputFile;
//	cout << "Nhap file can nen: ";    getline(cin, inputFile);
//	Huffman h;
//	h.encode(inputFile, "encode.txt");
//
//	cout << "\n-----LOADING------\n";
//
//	h.Init(); //Reset lai cau Huffman
//
//	//Doc file da nen va giai nen:
//	//FILE* fpread = fopen("output.txt", "rb");
//	fstream fpread("encode.txt", ios::in | ios::binary);
//	h.LoadHuffmanTree(fpread);
//	h.PrintFrequences();
//
//	int nRoot = h.makeHuffmanTree(); //Tao cay huffman tu du lieu vua load
//	h.PrintHuffmanTree(nRoot, 0);
//	h.generalBitCode(nRoot);
//	h.PrintTableBitCode();
//
//	h.Decompress(nRoot, fpread);
//
//	return 0;
//}
...
void main() {
	// nen
	NenHuffman("phuong.txt", "output.txt");
